...
func run(runner) -> void:
	...
	if game_loop.has_method("record_enemy_defeat"):
		...
		runner.assert_true(game_loop.terminal_pause_active, "boss defeat should enter terminal pause state")
	...
	if defeat_loop.has_method("record_player_defeat"):
		...
		runner.assert_true(defeat_loop.terminal_pause_active, "player defeat should enter terminal pause state")
